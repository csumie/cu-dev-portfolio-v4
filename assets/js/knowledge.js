jQuery(document).ready(function($) {
  var timelines = $('.about-horizontal-timeline'),
  ...
  function initTimeline(timelines) {
    timelines.each(function() {
      ...
      timelineComponents['timelineNavigation'] = timeline.find('.about-timeline-navigation');
      timelineComponents['eventsContent'] = timeline.children('.about__content');
  ...
  */
  ...
  function checkMQ() {
    ...
    return window.getComputedStyle(document.querySelector('.about-horizontal-timeline'), '::before').getPropertyValue('content').replace(/'/g, "").replace(/"/g, "");
  }
